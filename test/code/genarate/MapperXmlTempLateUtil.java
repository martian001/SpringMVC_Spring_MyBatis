...
public class MapperXmlTempLateUtil {
   ...
   public void testMetaData() throws Exception {
      ...
      String tableName = "CHECKING_IN";
      m.put("tableName", tableName);
      m.put("beanName", "CheckingIn");
      m.put("packageModule", "checkingIn");
      m.put("lowercaseBeanName", "checkingIn");
      ...
      String templateParsing = CommomUtils.templateParsing(m, "MapperXmlTempLate.ftl");
